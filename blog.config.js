...
const BLOG = {
  ...
  AUTHOR: 'THEO', // 作者
  BIO: '普通人', // 作者简介
  LINK: 'https://notion-next-mm68gzvj8-txkthu.vercel.app/', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: '', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/txkthu', // 你的github个人主页
  CONTACT_TELEGRAM: 'https://t.me/txkhspnsz', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: 'www.linkedin.com/in/xinkai-tang-ba608', // 你的linkedIn 首页
